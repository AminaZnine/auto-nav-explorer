      ...
      <div className="space-y-4">
        <div className="flex gap-4">
          <button
            ...
            className="flex items-center gap-1 px-3 py-2 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors flex-1"
          >
            {isWifiEnabled ? (
            ...
            <span className={`text-sm font-medium ${isWifiEnabled ? 'text-purple-500' : 'text-gray-500'}`}>
              WiFi
            </span>
          </button>
          ...
          >
            ...
            <span className={`text-sm font-medium ${isBluetoothEnabled ? 'text-purple-500' : 'text-gray-500'}`}>
              Bluetooth
            </span>
          </button>
        </div>
